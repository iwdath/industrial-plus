...
- [**Packed Up**](https://www.curseforge.com/minecraft/mc-mods/packed-up-backpacks) open bag key **`R`** → **```Grave accent (`)```**
...
- Config for [**FastQuit**](https://www.curseforge.com/minecraft/mc-mods/fastquit-forge)
...
- [**Easy Magic**](https://www.curseforge.com/minecraft/mc-mods/easy-magic) **`[v4.3.3]`**
...
- [**Fast IP Ping**](https://www.curseforge.com/minecraft/mc-mods/fast-ip-ping) **`[v1.0.5]`**
...
- [**Obscure Tooltips**](https://www.curseforge.com/minecraft/mc-mods/obscure-tooltips) **`[v1.0 API9]`**
...
- [**Plasmo Voice (PV)**](https://modrinth.com/plugin/plasmo-voice) **`[v2.1.2]`**
...
- [**Seamless Loading Screen**](https://www.curseforge.com/minecraft/mc-mods/seamless-loading-screen-forge) **`[v4.0.2]`**
...
- [**Obscure API**](https://www.curseforge.com/minecraft/mc-mods/obscure-api) **`[v9]`**
...
- [**Inventory HUD+**](https://www.curseforge.com/minecraft/mc-mods/inventory-hud-forge) **`[v3.4.7]`**
...
- [**Xaero's Minimap**](https://www.curseforge.com/minecraft/mc-mods/xaeros-minimap) **`[v24.0.3]`**
- [**Xaero's World Map**](https://www.curseforge.com/minecraft/mc-mods/xaeros-world-map) **`[v1.38.1]`**
