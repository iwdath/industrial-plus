...
| [**Cloth Config API**][cloth-config-api] | <kbd>[**Applied Energistics 2<br>Wireless Terminals<br>(AE2WTLib)**][ae2wtlib],<br><br>[**Better Combat**][better-combat],<br><br>[**Epic Knights: Shields,<br>Armor and Weapons<br>(Epic Knights)**][epic-knights],<br><br>[**Simply Swords**][simply-swords]</kbd> | `client and server` |
